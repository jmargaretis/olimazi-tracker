...
<body><nav><div class=brand>olimazi<span>.online</span></div><div><a href="/">Dashboard</a> &nbsp; <a href="/manage">Management</a> &nbsp; <a href="/organizer">Organizer</a></div></nav><div class=hero><h1>Rental Manager<small>Sch. E</small></h1><p>Property management · static local view</p></div><section class=card><h2>Issues board</h2>{active}{resolved_html}</section><section class=card><h2>Documents</h2><table><thead><tr><th>Title</th><th>Type</th><th>Date</th><th>Expires</th><th>Source</th></tr></thead><tbody>{''.join(rows)}</tbody></table></section></body></html>"""
